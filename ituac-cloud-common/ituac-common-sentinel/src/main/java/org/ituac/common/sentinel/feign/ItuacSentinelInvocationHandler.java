...
@Slf4j
public class ItuacSentinelInvocationHandler implements InvocationHandler {
    ...
    ItuacSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SentinelInvocationHandler) {
            ItuacSentinelInvocationHandler other = (ItuacSentinelInvocationHandler) obj;
