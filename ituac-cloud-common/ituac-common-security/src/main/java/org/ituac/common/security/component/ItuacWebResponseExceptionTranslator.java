...
import org.ituac.common.security.exception.*;
 ...
 */
@Slf4j
public class ItuacWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
    ...
    private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
        ...
        return new ResponseEntity<>(new ItuacAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
