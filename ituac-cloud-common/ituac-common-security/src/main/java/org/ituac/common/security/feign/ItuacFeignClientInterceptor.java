 ...
 */
@Slf4j
public class ItuacFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
     ...
     */
    public ItuacFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext, OAuth2ProtectedResourceDetails resource,
