...
public class PageDto<T> implements IPage<T> {
     ...
     * @return 返回分页参数本身
     */
    public PageDto<T> addOrder(OrderItem... items) {
     ...
     * @return 返回分页参数本身
     */
    public PageDto<T> addOrder(List<OrderItem> items) {
        orders.addAll(items);
        return this;
    }
     ...
     */
    @Deprecated
    public PageDto<T> setAscs(List<String> ascs) {
     ...
     */
    @Deprecated
    public PageDto<T> setAsc(String... ascs) {
        // 保证原来方法 set 的语意
     ...
     */
    @Deprecated
    public PageDto<T> setDescs(List<String> descs) {
        // 保证原来方法 set 的语意
     ...
     */
    @Deprecated
    public PageDto<T> setDesc(String... descs) {
    ...
    public PageDto<T> setSearchCount(boolean isSearchCount) {
        this.isSearchCount = isSearchCount;
        return this;
    }
